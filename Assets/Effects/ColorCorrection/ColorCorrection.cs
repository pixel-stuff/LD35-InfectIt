...
namespace UnityStandardAssets.ImageEffects
{
    ...
    public class ColorCorrection : PostEffectsBase
	{
        ...
        public bool m_isSaturationStarted = false;
        ...
        public void startSaturation(float duration) {
            ...
            m_isSaturationStarted = true;
        }

        public void update(float t) {
            if (m_isSaturationStarted) {
                m_currentTime = t;
                saturation = Math.Max(0.0f, Math.Min(1.0f, 1.0f-m_currentTime / (m_endTime - m_startTime)));
            }
        }

        public void stopSaturation() {
            m_isSaturationStarted = false;
        }
